...
function initSearch() {
  ...
  request.open('GET', 'https://reclaimthewild.github.io/en/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://reclaimthewild.github.io/en/assets/css/just-the-docs-' + theme + '.css');
}
